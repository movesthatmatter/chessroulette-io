...
export declare const internalUserRecord: io.UnionC<[io.IntersectionC<[io.IntersectionC<[io.TypeC<{
    id: io.StringC;
    firstName: io.StringC;
    lastName: io.StringC;
    avatarId: io.StringC;
...
export declare type InternalUserRecord = io.TypeOf<typeof internalUserRecord>;
