...
export const roomWithLichessActivityRecord = io.intersection([
  roomRecord,
  io.type({
    activity: roomLichessActivityRecord,
  }),
]);

export type RoomWithLichessActivityRecord = io.TypeOf<typeof roomWithLichessActivityRecord>;
